# Generated by Django 5.1.1 on 2024-09-21 07:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(null=True, upload_to='assignments/avatars')),
        ...
        migrations.CreateModel(
            name='Channels',
            fields=[
                ('channelid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_id', models.ManyToManyField(related_name='group_students', to='api.member')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='assignments',
            name='reviewers_id',
            field=models.ManyToManyField(related_name='assignment_reviewers', to='api.member'),
        ),
        migrations.CreateModel(
            name='Submission',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submit_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.submission')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
        ...
        migrations.AddConstraint(
            model_name='member',
            constraint=models.UniqueConstraint(fields=('memberName', 'channel_id'), name='channel_member'),
        ),
    ]
